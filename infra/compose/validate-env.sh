...
required_vars=(POSTGRES_PASSWORD IAM_DB_PASSWORD SUPPLIER_DB_PASSWORD WORKFLOW_DB_PASSWORD RISK_DB_PASSWORD AUDIT_DB_PASSWORD REDIS_PASSWORD MINIO_ROOT_PASSWORD JWT_SIGNING_KEY GRAFANA_ADMIN_PASSWORD)
