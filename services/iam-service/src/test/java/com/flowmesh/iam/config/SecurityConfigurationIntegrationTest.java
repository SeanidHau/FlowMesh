 ...
 * 同时未认证用户不能访问受保护的 API 路径，且 401 响应体包含统一错误模型。</p>
 */
@AutoConfigureMockMvc
class SecurityConfigurationIntegrationTest extends PostgresIntegrationTest {
    ...
    /**
     * 验证匿名用户访问受保护 API 时返回 {@code 401 Unauthorized}，且响应体含 {@code code} 字段。
     *
     * @throws Exception 当模拟 HTTP 请求执行失败时抛出
     */
    @Test
