...
`FLOWMESH_PG_HOST`、`FLOWMESH_PG_PORT`、`FLOWMESH_PG_DATABASE`、`FLOWMESH_PG_USER`、`FLOWMESH_PG_SSLMODE`、`FLOWMESH_BACKUP_DB_USER`、`FLOWMESH_RETENTION_DB_USER`、`FLOWMESH_REDIS_HOST`、`FLOWMESH_REDIS_PORT`、`FLOWMESH_REDIS_USER`、`FLOWMESH_ROCKETMQ_NAMESRV_ADDR`、`FLOWMESH_ROCKETMQ_CA_FILE`、`FLOWMESH_OBJECT_STORAGE_ENDPOINT`、`FLOWMESH_HA_EXPECTED_PG_REPLICAS`、`FLOWMESH_HA_REDIS_HOSTS`、`FLOWMESH_HA_EXPECTED_REDIS_REPLICAS`、`FLOWMESH_PROMETHEUS_URL`、`FLOWMESH_ALERTMANAGER_URL`、`FLOWMESH_INGRESS_NAMESPACE`、`FLOWMESH_RUNTIME_SECRET_NAME`、`FLOWMESH_BACKUP_SECRET_NAME`、`FLOWMESH_BACKUP_POSTGRES_USER` 和 `FLOWMESH_RETENTION_SECRET_NAME`。
